    ...
    <div className={classes.root}>
      ...
      <Container>
        ...
        <Typography variant="body1" align="center">
          I used to work as a Court Clerk for <a href="https://www.seattle.gov/courts" target="_blank" rel="noopener noreferrer">Seattle Municipal Court</a>. I discovered my passion for software engineering and technology while I was exploring different career paths to improve my life goals. Public service has been an invaluable experience where I have met many great co-workers, judges, attorneys, police officers, and other public officials. However, after working in the court system for nearly 15 years and reaching the highest pay grade for my position, I realized that I needed to make the leap into technology. I quit my job, went to coding boot camp, and now I am looking for an opportunity to apply my new technical skill sets.
      </Typography>
        <br />
      </Container>      
    </div>
