    ...
    <div className={classes.root}>
      ...
      <Container>
        ...
        <Typography variant="body1" align="center">
          I used to be a Court Clerk for <a href="https://www.seattle.gov/courts" target="_blank" rel="noopener noreferrer">Seattle Municipal Court</a> before I discovered my passion for software engineering and technology. Public service has been an invaluable experience where I have met many great co-workers, judges, attorneys, police officers, and other public officials. For the last couple of years, I was learning programming and software engineering on my own. I didn't know if I was learning the right information or whether I would ever be good enough to pursue it as a profession. My desire to pursue a profession in software engineering and technology made me throw caution to the wind and I took that leap. I quit my job, went to coding boot camp, and now I am looking for an opportunity to apply my new technical skill sets.
      </Typography>
        <br />
      </Container>      
    </div>
